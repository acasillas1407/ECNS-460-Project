...
# Assuming 'trade_volume_df' is already loaded and cleaned
...
# Assuming trade_volume_df is already loaded
...
# Combine the plots side by side and collect the legends
